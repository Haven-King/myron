...
public class ChefTestBlock extends Block {
    public static final IntProperty FRAME = IntProperty.of("frame", 0, 39);

    public ChefTestBlock(Settings settings) {
        super(settings);
    ...
    public void scheduledTick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
        world.setBlockState(pos, state.with(FRAME, (state.get(FRAME) + 1) % 39));
